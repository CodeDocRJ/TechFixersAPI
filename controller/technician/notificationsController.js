...
module.exports.getNotificationList = async ( req, res ) =>
{
    try
    {
        ...
        const notifications = await NotificationModel.find( { techId: techId } ).sort( { createdAt: -1 } );
...
module.exports.getNotification = async ( req, res ) =>
{
    try
    {
        ...
        const notification = await NotificationModel.findOne( { _id: notificationId, techId: techId } );

...
// Dynamic folder name based on user ID
const setupStorage = (userId) => {
  console.log('Setting up storage for userId:', userId);

  const folderName = `profile-pictures/user-${userId}`;
  console.log('Setting up folderName:', folderName);
...
// Multer setup with Cloudinary storage
const upload = multer({ storage: setupStorage });
